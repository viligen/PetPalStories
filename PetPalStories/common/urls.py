...
from PetPalStories.common.views import index_view, MessageListView, mark_as_read, delete_message, \
    MessageStoryCreateView, favourite_story, MyFavouriteStories, MyPublishedStories
...
urlpatterns = [
    ...
    path('profile/<int:pk>/myfavouritestories/', MyFavouriteStories.as_view(), name='favourite stories user'),
    path('profile/<int:pk>/myownstories/', MyPublishedStories.as_view(), name='own published stories user'),

    path('stories/details/<slug:slug>/', include([
